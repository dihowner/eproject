...
<head>
        <meta charset="utf-8" />
        <title>Buy Airtime | Project Hub</title>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
								<h4><b>Airtime Topup</b></h4> Fill the form below to buy airtime for your loved ones at a discounted fee<br><br>
							</div>
						</div>
									...
									<div id="addMaterials" class="container tab-pane active">
										...
										<form method="post">
											...
											<label for="wallettype"><b>Choose Wallet to Debit</b></label>
													...
													<select class="form-control input-sm" name="networkName" id="networkName" required>
													...
													<input name="airAmnt" id="airAmnt" class="form-control input-sm" type="number" min="<?php echo $min_airtime;?>" max="<?php echo $max_airtime;?>" placeholder="Enter amount" required>
													<br>
													...
													<input value="<?php echo $air_percent;?>" id='percent' type="hidden">
													<br>
