            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
								<h4><b> Project Upload History</b></h4> Here you can see all project report you have uploaded<br><br>
							</div>
						</div>
								 ...
								 <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <?php
														$i = 0;
														$getHis = $action->query("select * from market where userid='$uid' order by projectID desc"); $getHis->execute();
														foreach ($getHis as $dss) { $i++;
													?>
													<td><?php echo $i;?></td>
													<td><?php echo $dss['date'];?></td>
													<td><?php echo $dss['project_name'];?> <br>
														<b style="color: brown">Degree : </b><?php echo $action->degree(strtolower($dss['degree_awarded']));?>
													</td>
