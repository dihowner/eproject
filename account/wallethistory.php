...
<head>
        <meta charset="utf-8" />
        <title>Wallet History | Project Hub</title>
            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
								<h4><b> Wallet History</b></h4> Fill the form below to upload your project<br><br>
							</div>
						</div>
								 ...
								 <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <?php
														$i = 0;
														$getHis = $action->query("select * from payment where userid='$uid' order by id desc limit 50"); $getHis->execute();
														foreach ($getHis as $dss) { $i++;
													?>
													<td><?php echo $i;?></td>
													<td><?php echo $dss['timed'];?></td>
													<td>&#8358;<?php echo number_format($dss['bfrAmnt'] , 2);?></td>
													<td>&#8358;<?php echo number_format($dss['amount'] , 2);?></td>
													<td>&#8358;<?php echo number_format($dss['aftAmnt'] , 2);?></td>
													<td><?php echo $dss['reference'];?></td>
													<td><?php echo $dss['method'];?></td>
												</tr>
												<?php } ?>
                                        </tbody>
                                    </table>
